...
typedef enum QUIC_CONNECTION_PRIORTY_SCHEME {
    QUIC_CONNECTION_PRIORITY_FIFO           = 0x0000,   // Sends stream data first come, first served. (Default)
    QUIC_CONNECTION_PRIORITY_ROUND_ROBIN    = 0x0001    // Sends stream data evenly multiplexed.
...
#define QUIC_PARAM_CONN_PRIORITY_SCHEME                 20  // QUIC_CONNECTION_PRIORTY_SCHEME
