...
typedef enum QUIC_STREAM_SCHEDULING_SCHEME {
    QUIC_STREAM_SCHEDULING_FIFO             = 0x0000,   // Sends stream data first come, first served. (Default)
    QUIC_STREAM_SCHEDULING_ROUND_ROBIN      = 0x0001,   // Sends stream data evenly multiplexed.
    QUIC_STREAM_SCHEDULING_COUNT                        // The number of stream scheduling schemes. 
...
#define QUIC_PARAM_CONN_STREAM_SCHED_SCHEME             20  // QUIC_STREAM_SCHEDULING_SCHEME
