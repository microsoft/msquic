...
#ifndef STATUS_QUIC_PATHID_LIMIT_REACHED
#define STATUS_QUIC_PATHID_LIMIT_REACHED ((NTSTATUS)0xC024000AL)
#endif
...
#define QUIC_STATUS_PATHID_LIMIT_REACHED    STATUS_QUIC_PATHID_LIMIT_REACHED    // 0xc024000a
