...
#define QUIC_POOL_ROUTE_RESOLUTION_WORKER       '94cQ' // Qc49 - QUIC route resolution worker
#define QUIC_POOL_ROUTE_RESOLUTION_OPERATION    'A4cQ' // Qc4A - QUIC route resolution operation
