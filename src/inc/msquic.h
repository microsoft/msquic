...
typedef enum QUIC_SERVER_RESUME_ZERORTT_LEVEL {
    QUIC_SERVER_NO_RESUME,
    QUIC_SERVER_RESUME_ONLY,
    QUIC_SERVER_RESUME_AND_ZERORTT
} QUIC_SERVER_RESUME_ZERORTT_LEVEL;
...
#define QUIC_PARAM_CONN_SERVER_ENABLE_RESUME_ZERORTT    23  // QUIC_SERVER_RESUME_ZERORTT_LEVEL
