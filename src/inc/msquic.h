...
typedef enum QUIC_CREDENTIAL_FLAGS {
    ...
    QUIC_CREDENTIAL_FLAG_SET_ALLOWED_CERT_ALGS                  = 0x00400000, // Schannel only currently
...
typedef enum QUIC_ALLOWED_CERT_ALG_FLAGS {
    QUIC_ALLOWED_CERT_ALG_NONE                          = 0x0,
    QUIC_ALLOWED_CERT_ALG_RSA                           = 0x1,
    QUIC_ALLOWED_CERT_ALG_ECDSA                         = 0x2,
} QUIC_ALLOWED_CERT_ALG_FLAGS;

DEFINE_ENUM_FLAG_OPERATORS(QUIC_ALLOWED_CERT_ALG_FLAGS);
...
typedef struct QUIC_CREDENTIAL_CONFIG {
    ...
    QUIC_ALLOWED_CERT_ALG_FLAGS AllowedCertAlgs;        // Optional w/ QUIC_CREDENTIAL_FLAG_SET_ALLOWED_CERT_ALGS
