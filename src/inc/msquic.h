...
typedef enum QUIC_CREDENTIAL_FLAGS {
    ...
    QUIC_CREDENTIAL_FLAG_SET_MULTIPLE                           = 0x00400000, // Schannel only currently
    QUIC_CREDENTIAL_FLAG_SET_ALLOWED_CERTIFICATE_ALGORITHMS     = 0x00800000, // Schannel only currently
