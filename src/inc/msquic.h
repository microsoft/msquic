...
typedef enum QUIC_CREDENTIAL_FLAGS {
    ...
    QUIC_CREDENTIAL_FLAG_CHAIN_CACHE_ONLY_URL_RETRIEVAL         = 0x00020000, // Schannel only currently
    QUIC_CREDENTIAL_FLAG_REVOCATION_CHECK_CACHE_ONLY            = 0x00040000, // Schannel only currently
