...
#define QUIC_PARAM_CONN_THIS_RELIABLE_RESET_ENABLED     0x05000019  // uint8_t (BOOLEAN)
#define QUIC_PARAM_CONN_PEER_RELIABLE_RESET_ENABLED     0x0500001A  // uint8_t (BOOLEAN)
