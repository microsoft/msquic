...
#ifndef ERROR_QUIC_PATHID_LIMIT_REACHED
#define ERROR_QUIC_PATHID_LIMIT_REACHED _HRESULT_TYPEDEF_(0x8041000AL)
#endif
...
#define QUIC_STATUS_PATHID_LIMIT_REACHED    ERROR_QUIC_PATHID_LIMIT_REACHED                 // 0x8041000A
