...
#define QUIC_STATUS_INVALID_STATE           __HRESULT_FROM_WIN32(ERROR_INVALID_STATE) // E_NOT_VALID_STATE
#define QUIC_STATUS_NOT_SUPPORTED           E_NOINTERFACE
#define QUIC_STATUS_NOT_FOUND               __HRESULT_FROM_WIN32(ERROR_NOT_FOUND)
#define QUIC_STATUS_BUFFER_TOO_SMALL        __HRESULT_FROM_WIN32(ERROR_INSUFFICIENT_BUFFER) //E_NOT_SUFFICIENT_BUFFER
#define QUIC_STATUS_HANDSHAKE_FAILURE       ERROR_QUIC_HANDSHAKE_FAILURE
#define QUIC_STATUS_ABORTED                 E_ABORT
#define QUIC_STATUS_ADDRESS_IN_USE          __HRESULT_FROM_WIN32(WSAEADDRINUSE)
...
#define QUIC_STATUS_UNREACHABLE             __HRESULT_FROM_WIN32(ERROR_HOST_UNREACHABLE)
#define QUIC_STATUS_INTERNAL_ERROR          ERROR_QUIC_INTERNAL_ERROR
#define QUIC_STATUS_CONNECTION_REFUSED      __HRESULT_FROM_WIN32(ERROR_CONNECTION_REFUSED)
...
#define QUIC_STATUS_TLS_ERROR               __HRESULT_FROM_WIN32(WSA_SECURE_HOST_NOT_FOUND)
