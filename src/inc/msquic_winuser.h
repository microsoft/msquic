...
#define QUIC_STATUS_CONNECTION_TIMEOUT  HRESULT_FROM_WIN32(ERROR_NETWORK_UNREACHABLE)
#define QUIC_STATUS_CONNECTION_IDLE     HRESULT_FROM_WIN32(ERROR_CONNECTION_ABORTED)
#define QUIC_STATUS_UNREACHABLE         HRESULT_FROM_WIN32(ERROR_HOST_UNREACHABLE)
#define QUIC_STATUS_INTERNAL_ERROR      E_FAIL
#define QUIC_STATUS_SERVER_BUSY         HRESULT_FROM_WIN32(ERROR_CONNECTION_REFUSED)
