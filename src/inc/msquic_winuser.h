...
#define QUIC_STATUS_INVALID_STATE           QUIC_STATUS_HRESULT_FROM_WIN32(ERROR_INVALID_STATE)  // 0x8007139f
...
#define QUIC_STATUS_BUFFER_TOO_SMALL        QUIC_STATUS_HRESULT_FROM_WIN32(ERROR_INSUFFICIENT_BUFFER)   // 0x8007007a
