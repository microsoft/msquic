    ...
    )
{
    ...
    QuicTraceEvent(
        ...
        Connection,
        CLOG_VNL(ClientVNI->CompatibleVersionCount * sizeof(uint32_t), ClientVNI->CompatibleVersions));

    QuicTraceEvent(
        ConnClientReceivedVersionList,
        "[conn][%p] Client VNI Received Version List: %!VNL!",
        Connection,
        CLOG_VNL(ClientVNI->RecvNegotiationVerCount * sizeof(uint32_t), ClientVNI->RecvNegotiationVersions));
    ...
    )
{
    ...
    QuicTraceEvent(
        ...
        Connection,
        CLOG_VNL(ServerVNI->SupportedVersionCount * sizeof(uint32_t), ServerVNI->SupportedVersions));
    ...
    *VNInfoLength = 0;
    if (QuicConnIsServer(Connection)) {
        ...
        QuicTraceEvent(
            ...
            "[conn][%p] Server VNI Supported Version List: %!VNL!",
            Connection,
            CLOG_VNL(DesiredVersionsListLength * sizeof(uint32_t), VNIBuf));
    } else {
        //
        // Generate Client VNI
        //
