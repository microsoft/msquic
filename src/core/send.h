...
#define QUIC_CONN_SEND_FLAG_ACK                     UINT32_C(0x00000001)
#define QUIC_CONN_SEND_FLAG_CRYPTO                  UINT32_C(0x00000002)
#define QUIC_CONN_SEND_FLAG_CONNECTION_CLOSE        UINT32_C(0x00000004)
#define QUIC_CONN_SEND_FLAG_APPLICATION_CLOSE       UINT32_C(0x00000008)
#define QUIC_CONN_SEND_FLAG_DATA_BLOCKED            UINT32_C(0x00000010)
#define QUIC_CONN_SEND_FLAG_MAX_DATA                UINT32_C(0x00000020)
#define QUIC_CONN_SEND_FLAG_MAX_STREAMS_BIDI        UINT32_C(0x00000040)
#define QUIC_CONN_SEND_FLAG_MAX_STREAMS_UNI         UINT32_C(0x00000080)
#define QUIC_CONN_SEND_FLAG_NEW_CONNECTION_ID       UINT32_C(0x00000100)
#define QUIC_CONN_SEND_FLAG_RETIRE_CONNECTION_ID    UINT32_C(0x00000200)
#define QUIC_CONN_SEND_FLAG_PATH_CHALLENGE          UINT32_C(0x00000400)
#define QUIC_CONN_SEND_FLAG_PATH_RESPONSE           UINT32_C(0x00000800)
#define QUIC_CONN_SEND_FLAG_PING                    UINT32_C(0x00001000)
#define QUIC_CONN_SEND_FLAG_HANDSHAKE_DONE          UINT32_C(0x00002000)
#define QUIC_CONN_SEND_FLAG_DATAGRAM                UINT32_C(0x00004000)
#define QUIC_CONN_SEND_FLAG_PMTUD                   UINT32_C(0x80000000)
...
#define QUIC_STREAM_SEND_FLAG_DATA_BLOCKED  UINT32_C(0x0001)
#define QUIC_STREAM_SEND_FLAG_MAX_DATA      UINT32_C(0x0002)
#define QUIC_STREAM_SEND_FLAG_SEND_ABORT    UINT32_C(0x0004)
#define QUIC_STREAM_SEND_FLAG_RECV_ABORT    UINT32_C(0x0008)
#define QUIC_STREAM_SEND_FLAG_DATA          UINT32_C(0x0010)
#define QUIC_STREAM_SEND_FLAG_OPEN          UINT32_C(0x0020)
#define QUIC_STREAM_SEND_FLAG_FIN           UINT32_C(0x0040)

#define QUIC_STREAM_SEND_FLAGS_ALL          UINT32_C(0xFFFF)
