...
#define QUIC_CONN_SEND_FLAG_PATH_ACK                0x00040000U
#define QUIC_CONN_SEND_FLAG_PATH_ABANDON            0x00080000U
#define QUIC_CONN_SEND_FLAG_PATH_BACKUP             0x00100000U
#define QUIC_CONN_SEND_FLAG_PATH_AVAILABLE          0x00200000U
#define QUIC_CONN_SEND_FLAG_MAX_PATH_ID             0x00400000U
#define QUIC_CONN_SEND_FLAG_PATHS_BLOCKED           0x00800000U
