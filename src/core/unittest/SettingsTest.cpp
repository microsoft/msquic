...
TEST(SettingsTest, TestAllSettingsFieldsSet)
{
    ...
    SETTINGS_FEATURE_SET_TEST(SrcCidUpdateIdleTimeoutMs, QuicSettingsSettingsToInternal);
...
TEST(SettingsTest, TestAllSettingsFieldsGet)
{
    ...
    SETTINGS_FEATURE_GET_TEST(SrcCidUpdateIdleTimeoutMs, QuicSettingsGetSettings);
