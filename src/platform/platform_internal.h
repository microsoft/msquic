...
//
// Destroyed the given execution context.
//
void
CxPlatEcDestroy(
    _In_ CXPLAT_EC* Ec
...
//
// Runs one iteration of the execution context.
//
void
CxPlatEcRunLoop(
    _In_ CXPLAT_EC* Ec
...
//
// Processes an event for the given execution context.
//
void
CxPlatEcProcessEvent(
    _In_ CXPLAT_EC* Ec,
    _In_ CXPLAT_CQE* Event
    );
