...
#define CXPLAT_CQE_TYPE_DATAPATH_SHUTDOWN   CXPLAT_CQE_TYPE_QUIC_BASE + 3
#define CXPLAT_CQE_TYPE_SOCKET_SHUTDOWN     CXPLAT_CQE_TYPE_QUIC_BASE + 4
#define CXPLAT_CQE_TYPE_SOCKET_IO           CXPLAT_CQE_TYPE_QUIC_BASE + 5
