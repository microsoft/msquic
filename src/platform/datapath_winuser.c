...
// TODO: Uncomment this when Windows adds DSCP support on fast UDP indication path.
// {
//     //
    ...
    )
{
    ...
    DATAPATH_RX_IO_BLOCK* IoBlock = CxPlatPoolAlloc(&DatapathProc->RecvDatagramPool.Base);
