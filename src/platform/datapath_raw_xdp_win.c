    ...
    )
{
    ...
    if (Socket->Wildcard) {
        ...
        if (Socket->CibirIdLength) {
            Rules[0].Match = UseQTIP ? XDP_MATCH_TCP_QUIC_FLOW_SRC_CID : XDP_MATCH_QUIC_FLOW_SRC_CID;
            ...
            Rules[1].Match = UseQTIP ? XDP_MATCH_TCP_QUIC_FLOW_DST_CID : XDP_MATCH_QUIC_FLOW_DST_CID;
            ...
            Rules[0].Match = UseQTIP ? XDP_MATCH_TCP_DST : XDP_MATCH_UDP_DST;
