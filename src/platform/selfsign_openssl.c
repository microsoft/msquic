    ...
    )
{
    ...
    if (PKey == NULL) {
        QuicTraceEvent(LibraryError, "[ lib] ERROR, %s.", "EVP_PKEY_new() failed");
    ...
    if (BigNum == NULL) {
        QuicTraceEvent(LibraryError, "[ lib] ERROR, %s.", "BN_new() failed");
        Status = QUIC_STATUS_TLS_ERROR;
        goto Exit;
    }
    ...
    if (Ret != 1) {
        QuicTraceEvent(LibraryError, "[ lib] ERROR, %s.", "BN_set_word() failed");
        Status = QUIC_STATUS_TLS_ERROR;
        goto Exit;
    }
    ...
    if (Rsa == NULL) {
        QuicTraceEvent(LibraryError, "[ lib] ERROR, %s.", "RSA_new() failed");
        Status = QUIC_STATUS_TLS_ERROR;
        goto Exit;
    }
    ...
    if (Ret != 1) {
        QuicTraceEvent(LibraryError, "[ lib] ERROR, %s.", "RSA_generate_key_ex() failed");
        Status = QUIC_STATUS_TLS_ERROR;
        goto Exit;
    }
    ...
    if (Ret != 1) {
        QuicTraceEvent(LibraryError, "[ lib] ERROR, %s.", "EVP_PKEY_assign_RSA() failed");
        Status = QUIC_STATUS_TLS_ERROR;
        goto Exit;
    }
    ...
    if (X509 == NULL) {
        QuicTraceEvent(LibraryError, "[ lib] ERROR, %s.", "X509_new() failed");
        Status = QUIC_STATUS_TLS_ERROR;
        goto Exit;
    }
    ...
    if (Ret != 1) {
        QuicTraceEvent(LibraryError, "[ lib] ERROR, %s.", "ASN1_INTEGER_set() failed");
        Status = QUIC_STATUS_TLS_ERROR;
        goto Exit;
    }
    ...
    if (Ret != 1) {
        QuicTraceEvent(LibraryError, "[ lib] ERROR, %s.", "X509_NAME_add_entry_by_txt() failed");
        Status = QUIC_STATUS_TLS_ERROR;
        goto Exit;
    }
    ...
    if (Ret != 1) {
        QuicTraceEvent(LibraryError, "[ lib] ERROR, %s.", "X509_set_issuer_name() failed");
        Status = QUIC_STATUS_TLS_ERROR;
        goto Exit;
    }
    ...
    if (Ret <= 0) {
        QuicTraceEvent(LibraryError, "[ lib] ERROR, %s.", "X509_sign() failed");
        Status = QUIC_STATUS_TLS_ERROR;
        goto Exit;
    }
    ...
    if (Fd == NULL) {
        QuicTraceEvent(LibraryError, "[ lib] ERROR, %s.", "fopen() failed");
        Status = QUIC_STATUS_TLS_ERROR;
        goto Exit;
    }
    ...
    if (Ret != 1) {
        QuicTraceEvent(LibraryError, "[ lib] ERROR, %s.", "PEM_write_PrivateKey() failed");
        Status = QUIC_STATUS_TLS_ERROR;
        goto Exit;
    }
    ...
    if (Ret != 1) {
        QuicTraceEvent(LibraryError, "[ lib] ERROR, %s.", "PEM_write_X509() failed");
        Status = QUIC_STATUS_TLS_ERROR;
        goto Exit;
    }
    ...
    )
{
    ...
    if (Params->TempDir == NULL) {
        QuicTraceEvent(LibraryError, "[ lib] ERROR, %s.", "mkdtemp failed");
        goto Error;
    }
    ...
    )
{
    ...
    if (system(RmCmd) == -1) {
        QuicTraceEvent(LibraryError, "[ lib] ERROR, %s.", "Tempdir del error");
    }
