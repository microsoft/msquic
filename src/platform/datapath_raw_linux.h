...
#ifndef _MSQUIC_SRC_PLATFORM_DATAPATH_RAW_LINUX_H_
#define _MSQUIC_SRC_PLATFORM_DATAPATH_RAW_LINUX_H_
...
#endif  //  #ifndef _MSQUIC_SRC_PLATFORM_DATAPATH_RAW_LINUX_H_
