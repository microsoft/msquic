...
pub const QUIC_STREAM_EVENT_TYPE_QUIC_STREAM_EVENT_RECEIVE_BUFFER_NEEDED:
...
const _: () = {
    ...
    ["Offset of field: QUIC_STREAM_EVENT__bindgen_ty_1::RECEIVE_BUFFER_NEEDED"][::std::mem::offset_of!(
