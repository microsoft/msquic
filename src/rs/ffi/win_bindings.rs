...
pub const QUIC_STREAM_EVENT_TYPE_QUIC_STREAM_EVENT_INSUFFICIENT_RECEIVE_BUFFER:
...
pub union QUIC_STREAM_EVENT__bindgen_ty_1 {
    ...
    pub INSUFFICIENT_RECEIVE_BUFFER: QUIC_STREAM_EVENT__bindgen_ty_1__bindgen_ty_10,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ...
    ["Offset of field: QUIC_STREAM_EVENT__bindgen_ty_1::INSUFFICIENT_RECEIVE_BUFFER"][::std::mem::offset_of!(
