...
pub const QUIC_CREDENTIAL_FLAGS_QUIC_CREDENTIAL_FLAG_DISABLE_RESUMPTION: QUIC_CREDENTIAL_FLAGS =
    4194304;
pub const QUIC_CREDENTIAL_FLAGS_QUIC_CREDENTIAL_FLAG_ALLOW_RESUMPTION_TICKET_MANAGEMENT:
    QUIC_CREDENTIAL_FLAGS = 8388608;
