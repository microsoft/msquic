...
----------------------------------------------------------*/
TRACEPOINT_EVENT(CLOG_CONNECTION_C, ClientVersionNegotiationInfoVersionMismatch,
    TP_ARGS(
        const void *, arg1,
        unsigned int, arg3,
        unsigned int, arg4), 
...
// arg1 = arg1 = Connection
----------------------------------------------------------*/
TRACEPOINT_EVENT(CLOG_CONNECTION_C, ClientVersionNegotiationRecvdVersionsMismatch,
    TP_ARGS(
        const void *, arg1), 
    TP_FIELDS(
        ctf_integer_hex(uint64_t, arg1, arg1)
...
----------------------------------------------------------*/
TRACEPOINT_EVENT(CLOG_CONNECTION_C, ClientVersionNegotiationPrevVersionIncorrect,
    TP_ARGS(
        const void *, arg1,
        unsigned int, arg3), 
    TP_FIELDS(
...
// arg4 = arg4 = Connection->Stats.QuicVersion
----------------------------------------------------------*/
TRACEPOINT_EVENT(CLOG_CONNECTION_C, ServerVersionNegotiationInfoVersionMismatch,
    TP_ARGS(
        const void *, arg1,
        unsigned int, arg3,
        unsigned int, arg4), 
...
----------------------------------------------------------*/
TRACEPOINT_EVENT(CLOG_CONNECTION_C, ServerVersionNegotiationNegotiatedVersionNotInSupportedList,
    TP_ARGS(
        const void *, arg1,
        unsigned int, arg3), 
    TP_FIELDS(
...
// arg1 = arg1 = Connection
----------------------------------------------------------*/
TRACEPOINT_EVENT(CLOG_CONNECTION_C, ApiEventAlreadyClosed,
    TP_ARGS(
        const void *, arg1), 
    TP_FIELDS(
        ctf_integer_hex(uint64_t, arg1, arg1)
...
----------------------------------------------------------*/
TRACEPOINT_EVENT(CLOG_CONNECTION_C, RttUpdated,
    TP_ARGS(
        const void *, arg1,
        unsigned int, arg3,
        unsigned int, arg4,
