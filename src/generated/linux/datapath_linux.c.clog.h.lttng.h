...
----------------------------------------------------------*/
TRACEPOINT_EVENT(CLOG_DATAPATH_LINUX_C, DatapathWorkerThreadStart,
    TP_ARGS(
        const void *, arg2), 
    TP_FIELDS(
...
// arg2 = arg2 = ProcContext
----------------------------------------------------------*/
TRACEPOINT_EVENT(CLOG_DATAPATH_LINUX_C, DatapathWorkerThreadStop,
    TP_ARGS(
        const void *, arg2), 
    TP_FIELDS(
        ctf_integer_hex(uint64_t, arg2, arg2)
...
----------------------------------------------------------*/
TRACEPOINT_EVENT(CLOG_DATAPATH_LINUX_C, AllocFailure,
    TP_ARGS(
        const char *, arg2,
...
----------------------------------------------------------*/
TRACEPOINT_EVENT(CLOG_DATAPATH_LINUX_C, LibraryError,
    TP_ARGS(
        const char *, arg2), 
    TP_FIELDS(
        ctf_string(arg2, arg2)
...
----------------------------------------------------------*/
TRACEPOINT_EVENT(CLOG_DATAPATH_LINUX_C, DatapathRecv,
    TP_ARGS(
        const void *, arg2,
        unsigned int, arg3,
        unsigned short, arg4,
...
----------------------------------------------------------*/
TRACEPOINT_EVENT(CLOG_DATAPATH_LINUX_C, DatapathCreated,
    TP_ARGS(
        const void *, arg2,
...
// arg2 = arg2 = Binding
----------------------------------------------------------*/
TRACEPOINT_EVENT(CLOG_DATAPATH_LINUX_C, DatapathDestroyed,
    TP_ARGS(
        const void *, arg2), 
    TP_FIELDS(
        ctf_integer_hex(uint64_t, arg2, arg2)
...
// arg2 = arg2 = Binding
// arg3 = arg3 = TotalSize
// arg4 = arg4 = SendContext->BufferCount
// arg5 = arg5 = SendContext->Buffers[0].Length
// arg6 = arg6 = CLOG_BYTEARRAY(sizeof(*RemoteAddress), RemoteAddress)
// arg7 = arg7 = CLOG_BYTEARRAY(sizeof(*LocalAddress), LocalAddress)
----------------------------------------------------------*/
TRACEPOINT_EVENT(CLOG_DATAPATH_LINUX_C, DatapathSend,
    TP_ARGS(
        const void *, arg2,
        unsigned int, arg3,
        unsigned char, arg4,
