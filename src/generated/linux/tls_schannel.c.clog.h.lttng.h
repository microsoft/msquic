...
// QuicTraceLogVerbose(
        ...
        "[ tls] Library initialized");
----------------------------------------------------------*/
TRACEPOINT_EVENT(CLOG_TLS_SCHANNEL_C, SchannelInitialized,
    TP_ARGS(
), 
    TP_FIELDS(
    )
...
// QuicTraceLogVerbose(
        ...
        "[ tls] Library uninitialized");
----------------------------------------------------------*/
TRACEPOINT_EVENT(CLOG_TLS_SCHANNEL_C, SchannelUninitialized,
    TP_ARGS(
), 
    TP_FIELDS(
    )
...
// arg4 = arg4 = SecretStr
----------------------------------------------------------*/
TRACEPOINT_EVENT(CLOG_TLS_SCHANNEL_C, SchannelLogSecret,
    TP_ARGS(
        const char *, arg2,
        unsigned int, arg3,
        const char *, arg4), 
