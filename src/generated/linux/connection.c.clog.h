...
#ifndef _clog_5_ARGS_TRACE_ClientVersionNegotiationInfoVersionMismatch



/*----------------------------------------------------------
// Decoder Ring for ClientVersionNegotiationInfoVersionMismatch
// [conn][%p] Client Current Version doesn't match long header. 0x%x != 0x%x
...
----------------------------------------------------------*/
#define _clog_5_ARGS_TRACE_ClientVersionNegotiationInfoVersionMismatch(uniqueId, arg1, encoded_arg_string, arg3, arg4)\
tracepoint(CLOG_CONNECTION_C, ClientVersionNegotiationInfoVersionMismatch , arg1, arg3, arg4);\
...
#ifndef _clog_3_ARGS_TRACE_ClientVersionNegotiationRecvdVersionsMismatch



/*----------------------------------------------------------
// Decoder Ring for ClientVersionNegotiationRecvdVersionsMismatch
// [conn][%p] Client Received Versions list doesn't match server
// QuicTraceLogConnError(
...
// arg1 = arg1 = Connection
----------------------------------------------------------*/
#define _clog_3_ARGS_TRACE_ClientVersionNegotiationRecvdVersionsMismatch(uniqueId, arg1, encoded_arg_string)\
tracepoint(CLOG_CONNECTION_C, ClientVersionNegotiationRecvdVersionsMismatch , arg1);\
...
#ifndef _clog_4_ARGS_TRACE_ClientVersionNegotiationPrevVersionIncorrect



/*----------------------------------------------------------
// Decoder Ring for ClientVersionNegotiationPrevVersionIncorrect
// [conn][%p] Client Previous Version is supported: 0x%x
// QuicTraceLogConnError(
...
// arg1 = arg1 = Connection
// arg3 = arg3 = ClientVNI.PreviousVersion
----------------------------------------------------------*/
#define _clog_4_ARGS_TRACE_ClientVersionNegotiationPrevVersionIncorrect(uniqueId, arg1, encoded_arg_string, arg3)\
tracepoint(CLOG_CONNECTION_C, ClientVersionNegotiationPrevVersionIncorrect , arg1, arg3);\
...
#ifndef _clog_5_ARGS_TRACE_ServerVersionNegotiationInfoVersionMismatch



/*----------------------------------------------------------
// Decoder Ring for ServerVersionNegotiationInfoVersionMismatch
// [conn][%p] Server Negotiated Version doesn't match long header. 0x%x != 0x%x
// QuicTraceLogConnError(
...
// arg4 = arg4 = Connection->Stats.QuicVersion
----------------------------------------------------------*/
#define _clog_5_ARGS_TRACE_ServerVersionNegotiationInfoVersionMismatch(uniqueId, arg1, encoded_arg_string, arg3, arg4)\
tracepoint(CLOG_CONNECTION_C, ServerVersionNegotiationInfoVersionMismatch , arg1, arg3, arg4);\
...
#ifndef _clog_4_ARGS_TRACE_ServerVersionNegotiationNegotiatedVersionNotInSupportedList



/*----------------------------------------------------------
// Decoder Ring for ServerVersionNegotiationNegotiatedVersionNotInSupportedList
// [conn][%p] Server Negotiated Version is not in Server Supported Versions: 0x%x
// QuicTraceLogConnError(
...
// arg1 = arg1 = Connection
// arg3 = arg3 = CxPlatByteSwapUint32(ServerVNI.NegotiatedVersion)
----------------------------------------------------------*/
#define _clog_4_ARGS_TRACE_ServerVersionNegotiationNegotiatedVersionNotInSupportedList(uniqueId, arg1, encoded_arg_string, arg3)\
tracepoint(CLOG_CONNECTION_C, ServerVersionNegotiationNegotiatedVersionNotInSupportedList , arg1, arg3);\
...
#ifndef _clog_3_ARGS_TRACE_ApiEventAlreadyClosed



/*----------------------------------------------------------
// Decoder Ring for ApiEventAlreadyClosed
// [conn][%p] Event silently discarded.
// QuicTraceLogConnWarning(
...
// arg1 = arg1 = Connection
----------------------------------------------------------*/
#define _clog_3_ARGS_TRACE_ApiEventAlreadyClosed(uniqueId, arg1, encoded_arg_string)\
tracepoint(CLOG_CONNECTION_C, ApiEventAlreadyClosed , arg1);\
...
// arg1 = arg1 = Connection
// arg3 = arg3 = CLOG_BYTEARRAY(sizeof(Connection->PeerTransportParams.PreferredAddress), &Connection->PeerTransportParams.PreferredAddress)
----------------------------------------------------------*/
...
#ifndef _clog_7_ARGS_TRACE_RttUpdated



/*----------------------------------------------------------
// Decoder Ring for RttUpdated
...
----------------------------------------------------------*/
#define _clog_7_ARGS_TRACE_RttUpdated(uniqueId, arg1, encoded_arg_string, arg3, arg4, arg5, arg6)\
tracepoint(CLOG_CONNECTION_C, RttUpdated , arg1, arg3, arg4, arg5, arg6);\
...
// arg2 = arg2 = Connection
// arg3 = arg3 = CLOG_BYTEARRAY(sizeof(Path->LocalAddress), &Path->LocalAddress)
----------------------------------------------------------*/
...
// arg2 = arg2 = Connection
// arg3 = arg3 = CLOG_BYTEARRAY(sizeof(Path->RemoteAddress), &Path->RemoteAddress)
----------------------------------------------------------*/
...
// arg4 = arg4 = CLOG_BYTEARRAY(Path->DestCid->CID.Length, Path->DestCid->CID.Data)
----------------------------------------------------------*/
...
// arg4 = arg4 = CLOG_BYTEARRAY(SourceCid->CID.Length, SourceCid->CID.Data)
----------------------------------------------------------*/
...
// arg2 = arg2 = Connection
// arg3 = arg3 = CLOG_BYTEARRAY(sizeof(Connection->Paths[i].LocalAddress), &Connection->Paths[i].LocalAddress)
----------------------------------------------------------*/
#define _clog_5_ARGS_TRACE_ConnLocalAddrAdded(uniqueId, encoded_arg_string, arg2, arg3, arg3_len)\
...
// arg2 = arg2 = Connection
// arg3 = arg3 = CLOG_BYTEARRAY(sizeof(Connection->Paths[i].RemoteAddress), &Connection->Paths[i].RemoteAddress)
----------------------------------------------------------*/
#define _clog_5_ARGS_TRACE_ConnRemoteAddrAdded(uniqueId, encoded_arg_string, arg2, arg3, arg3_len)\
...
// arg4 = arg4 = CLOG_BYTEARRAY(DestCid->CID.Length, DestCid->CID.Data)
----------------------------------------------------------*/
#define _clog_6_ARGS_TRACE_ConnDestCidAdded(uniqueId, encoded_arg_string, arg2, arg3, arg4, arg4_len)\
...
// arg2 = arg2 = Connection
// arg3 = arg3 = Status
// arg4 = arg4 = "QuicBindingGenerateStatelessResetToken"
----------------------------------------------------------*/
#define _clog_5_ARGS_TRACE_ConnErrorStatus(uniqueId, encoded_arg_string, arg2, arg3, arg4)\
...
// arg2 = arg2 = "Received version list"
// arg3 = arg3 = ServerVersionListLength * sizeof(uint32_t)
----------------------------------------------------------*/
#define _clog_4_ARGS_TRACE_AllocFailure(uniqueId, encoded_arg_string, arg2, arg3)\
...
// arg3 = arg3 = sizeof(QUIC_CID_CXPLAT_LIST_ENTRY) + Frame.Length
----------------------------------------------------------*/
#define _clog_4_ARGS_TRACE_AllocFailure(uniqueId, encoded_arg_string, arg2, arg3)\
...
// QuicTraceEvent(
            ...
            "[conn][%p] New Remote IP: %!ADDR!",
            Connection,
            CLOG_BYTEARRAY(sizeof(Connection->Paths[0].RemoteAddress), &Connection->Paths[0].RemoteAddress));
// arg2 = arg2 = Connection
// arg3 = arg3 = CLOG_BYTEARRAY(sizeof(Connection->Paths[0].RemoteAddress), &Connection->Paths[0].RemoteAddress)
----------------------------------------------------------*/
#define _clog_5_ARGS_TRACE_ConnRemoteAddrAdded(uniqueId, encoded_arg_string, arg2, arg3, arg3_len)\
...
// arg2 = arg2 = Connection
// arg3 = arg3 = CLOG_BYTEARRAY(sizeof(Connection->Paths[0].LocalAddress), &Connection->Paths[0].LocalAddress)
----------------------------------------------------------*/
#define _clog_5_ARGS_TRACE_ConnLocalAddrAdded(uniqueId, encoded_arg_string, arg2, arg3, arg3_len)\
