    ...
    )
{
    ...
    MsQuicCredentialConfig GoodServerConfig(ServerCredConfig);
#ifndef QUIC_DISABLE_0RTT_TESTS
    uint8_t GoodTicketKey[44] = {0};
    GoodServerConfig.TicketKey = GoodTicketKey;

    MsQuicCredentialConfig BadServerConfig(ServerCredConfig);
    ...
    )
{
    ...
    MsQuicConfiguration ServerConfiguration(Registration, Alpn, ServerCredConfig);
    TEST_TRUE(ServerConfiguration.IsValid());
