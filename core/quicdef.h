...
typedef struct _QUIC_BINDING QUIC_BINDING, *PQUIC_BINDING;
typedef struct _QUIC_OPERATION QUIC_OPERATION, *PQUIC_OPERATION;
typedef struct _QUIC_WORKER QUIC_WORKER, *PQUIC_WORKER;
typedef struct _QUIC_WORKER_POOL QUIC_WORKER_POOL, *PQUIC_WORKER_POOL;
typedef struct _QUIC_REGISTRATION QUIC_REGISTRATION, *PQUIC_REGISTRATION;
typedef struct _QUIC_SESSION QUIC_SESSION, *PQUIC_SESSION;
