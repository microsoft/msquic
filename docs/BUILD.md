...
The full MsQuic build system relies on [CMake](https://cmake.org/) (3.16 of better), [.NET Core](https://dotnet.microsoft.com/download/dotnet-core) (3.1 SDK) and [Powershell](https://docs.microsoft.com/en-us/powershell/scripting/install/installing-powershell) (7.0 or better) on all platforms.
