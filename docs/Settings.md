...
| `QUIC_PARAM_LISTENER_CIBIR_ID`<br> 2    | QUIC_CIBIR_ID  | Both  | The CIBIR well-known idenfitier.        |
...
| `QUIC_PARAM_CONN_CIBIR_ID`<br> 21      | QUIC_CIBIR_ID  | Set-only  | The CIBIR well-known identifier.                                                             |
