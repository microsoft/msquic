...
| `QUIC_PARAM_GLOBAL_RAW_DATAPATH_PROCS`<br> 9      | uint32_t[]              | Both      | Globally change the list of CPUs that raw datapath can use. Must be set before opening registration.  |
