...
| Idle Timeout Period Changes SrcCid | uint32_t   | SrcCidUpdateIdleTimeoutMs          |             20000 | Idle timeout period after which the source CID is updated before sending again.                                               |
